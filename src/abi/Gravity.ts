...
export const events = {
    NewGravatar: event("0x9ab3aefb2ba6dc12910ac1bce4692cf5c3c0d06cff16327c64a3ef78228b130b", "NewGravatar(uint256,address,string,string)", {"id": p.uint256, "owner": p.address, "displayName": p.string, "imageUrl": p.string}),
    UpdatedGravatar: event("0x76571b7a897a1509c641587568218a290018fbdc8b9a724f17b77ff0eec22c0c", "UpdatedGravatar(uint256,address,string,string)", {"id": p.uint256, "owner": p.address, "displayName": p.string, "imageUrl": p.string}),
}

export const functions = {
    updateGravatarImage: fun("0x0081d6e5", "updateGravatarImage(string)", {"_imageUrl": p.string}, ),
    setMythicalGravatar: fun("0x1d4f2c6d", "setMythicalGravatar()", {}, ),
    getGravatar: viewFun("0x359c1f72", "getGravatar(address)", {"owner": p.address}, {"_0": p.string, "_1": p.string}),
    gravatarToOwner: viewFun("0x88d0d391", "gravatarToOwner(uint256)", {"_0": p.uint256}, p.address),
    ownerToGravatar: viewFun("0xa5ac3634", "ownerToGravatar(address)", {"_0": p.address}, p.uint256),
    updateGravatarName: fun("0xb18588fb", "updateGravatarName(string)", {"_displayName": p.string}, ),
    createGravatar: fun("0xcdb3344a", "createGravatar(string,string)", {"_displayName": p.string, "_imageUrl": p.string}, ),
    gravatars: viewFun("0xd5ce24ed", "gravatars(uint256)", {"_0": p.uint256}, {"owner": p.address, "displayName": p.string, "imageUrl": p.string}),
}
